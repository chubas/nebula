...
.defines(function () {
  ...
  //TODO: instead of this.constructor, use whatever construct this thing uses.

  Chameleon = {};
  Chameleon.Color = ig.Class.extend({
          _h : 0,
          _s : 0,
          _v : 0,
          _a : 100,
      ...
      Chameleon.Color.RGBRegExp = /^\s*rgba?\s*\((\d+)\,\s*(\d+)\,\s*(\d+)(,\s*(\d+(\.\d+)?))?\)\s*$/;
      Chameleon.Color.HTMLRegExp = /^\#([0-9A-Fa-f]{6})$/;
      Chameleon.Color.HTMLShortRegExp = /^\#([0-9A-Fa-f]{3})$/;

      Chameleon.Color.RGBToHSV = function RGBToHSV(r,g,b){
          r = r/255,
          g = g/255,
          b = b/255;
      ...
      Chameleon.Color.HexStringToHSV = function HexStringToHSV(hexString){
      ...
      Chameleon.Color.HSVToRGB = function HSVToRGB(h,s,v){
          var r,g,b;
